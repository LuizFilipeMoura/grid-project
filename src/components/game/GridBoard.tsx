...
import type {CharacterState, GameState, PlayerID, Point} from '../../types';
...
const UnitToken = ({unit, isSelected}: UnitTokenProps) => {
    ...
    return (
        <div className={classNames('unit-token', `unit-token--${unit.playerID}`)}
             aria-label={`${unit.name}, ${unit.class}`}>
